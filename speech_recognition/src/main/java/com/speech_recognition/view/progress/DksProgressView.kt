package com.speech_recognition.view.progress
...
import com.speech_recognition.view.animation.bounce.BounceAnimationDriver
...
class DksProgressView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0): FrameLayout(context) {
    ...
    private var btn_positive: TextView = findViewById(R.id.btn_positive)
    private var btn_neutral: TextView = findViewById(R.id.btn_neutral)
    private var btn_negative: TextView = findViewById(R.id.btn_neutral)
    private var tv_progress_message: TextView = findViewById(R.id.tv_progress_message)
    private var ll_progress_balls: LinearLayout = findViewById(R.id.ll_progress_balls)

    init {
        View.inflate(context, R.layout.layout_progress_view, this)
    findViewById<TextView>(R.id.btn_positive)
    ...
    fun setBackground(bgColor: Int, alpha: Float) {
        findViewById<View>(R.id.viewBg).setBackgroundColor(bgColor)
        findViewById<View>(R.id.viewBg).alpha = alpha
    }
